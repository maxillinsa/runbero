...
<html lang="en" dir="ltr">
	<head>
		...
		$res=mysql_query("select * from tblrunlog where tmonth=$mnt and tyear=$cboyear and payroll=$payid");
					...
					<div class="side-app">
						<div class="page-header">
												...
												<div class="col-xl-10 col-lg-12 col-md-12 d-block mx-auto">
													<div class="item-search-tabs">
														<div class="item-search-menu">
															<ul class="nav">
																<li class=""><a href="#tab1" class="active" data-toggle="tab">Payroll Employees Summary</a></li>
																<li><a href="#tab2" data-toggle="tab">Payroll Pay Elements</a></li>
						 ...
						 $cname=$crd['name'];
						  ...
						  $qryx="select distinct(tblrunlogitems.empid)employee from tblrunlogitems,tblrunlog where tblrunlogitems.tmonth=$mnt and tblrunlogitems.tyear=$cboyear and payroll=$payid and tblrunlogitems.logid=tblrunlog.id and payroll=$payid";
						  //echo $qryx;
						  ...
						  if($nmx<1){
							  echo "No record found";
									...
									do{
										...
										$cred=getEmployeeCredit($empid,$mnt,$cboyear,$payid);
						  ...
						  $qryx="select distinct tblrunlogitems.pelementid pelementid, payitemname pitem,creditdebit from tblrunlogitems,tblrunlog where tblrunlogitems.tmonth=$mnt and tblrunlogitems.tyear=$cboyear and payroll=$payid and tblrunlogitems.logid=tblrunlog.id and payroll=$payid";
						 // echo $qryx;
						  $resx=mysql_query($qryx);
						  $nmx=mysql_num_rows($resx);
						  $rdx=mysql_fetch_assoc($resx);
						  if($nmx<1){
							  echo "No record found";
									...
									do{
										...
										$ename=$rdx['pitem'];
										$cd=$rdx['creditdebit'];
										$cred=getPayElementAmt($payelemntid,$mnt,$cboyear,$payid);
										//$debit=getEmployeeDebit($empid,$mnt,$cboyear,$payid);
										$tearning=$cred-$debit;
										echo "<tr>";
										echo "<td>".$ename."</td>";
