						...
						<div class="page-header">
							...
							<div class="col-md-12 col-lg-10">
								<div class="card">
									...
									<?php echo "<a href='exportpension.php?payid=$payid&txtfrom=$txtfrom&txtto=$txtto' >"; ?><button type="button" class="btn btn-sm btn-secondary mr-2"><i class="fa fa-file-excel-o"></i> Export to Excel</button></a>
									<br>
