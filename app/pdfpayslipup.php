...
margin-bottom: 1rem;background-color:#022E64;padding:14px; font-size:22px;color:white;margin-top:7px;' >Deductions</span> </p>";
								...
								$savefilea=saveFile($logid,$tday,$tmonth,$tyear,$empidid,$filename,$compid,"pdf","Upfront File");
						...
						<div class="row" id="divres">
							<div class="col-md-12">
								<div class="card">
									...
									<br><br><h3 class="card-title" style="padding-left:70px;">Payslip PDF files are located in <b>My Team->Documents Bay</b></h3>
									<?php 
										//echo $pck;
