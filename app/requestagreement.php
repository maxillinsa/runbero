...
<html lang="en" dir="ltr">
	<head>
		...
		$ssn=mysql_query("update tblloans set signagreed='R' where id=$lnid");
							...
							<div class="col-md-12 col-lg-12">
								...
								<br><br>	<span style="font-size:30px;"><center><?php echo "'".$loanname."' "; ?> Agreement</center></span>
									...
									?>
										...
										<?php
										//echo $signagreed;
										if($signagreed=="R"){}else{ ?>
										<p><center><a href="javascript:sendagreement();" class="btn btn-primary"> <i class="fa fa-paper-plane"></i> Send Loan Agreement to <?php echo $elname; ?></a></center></p>
		...
		var lnid="<?php echo $lnid; ?>";
			...
			function sendagreement(){
					...
					$.post("controller/utility.php", {act: 'sendagreement',lnid:lnid},
						   function (data) {
							   ...
							   if (data.length > 0) {
								 ...
								 Tvar("divassign").innerHTML= "<h3 class='card-title' style='font-size:30px;'><i class='fa fa-paper-plane fa-lg' style='color:green;'></i> Loan Agreement Sent</h3><br>";
