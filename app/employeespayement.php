	...
	<head>
				...
				<div class="app-content  my-3 my-md-5">
					<div class="side-app">
						<div class="page-header">
							<h4 class="page-title">Assign Pay Element to Employee</h4>
							<ol class="breadcrumb">
											...
											<table id="example2" class="hover table-bordered border-top-0 border-bottom-0" >
												...
												<tbody>
													...
													<tr>
														...
														<td><?php 
														$empid=$rd['id'];
														echo " <a href='javascript:runpayroll(\"$empid\");' class='btn btn-sm btn-primary'>Customize <i class='fa fa-cut'></i> </a>"; ?></td>
		...
		<script src="../assets/js/admin-custom.js"></script>
			...
			function runpayroll(pid){
				//alert(pid);
				window.location="employeespayement2.php?empid="+pid;
			}
