											...
											<table id="example2" class="hover table-bordered border-top-0 border-bottom-0" >
												...
												<tbody>
													...
													<tr>
														...
														<td><?php if($active=="N"){  ?><a href="javascript:sendInvite('<?php echo $iid; ?>')"><button type="button" class="btn btn-sm btn-warning mr-2"><i class="fa fa-envelope-o"></i> Resend Invite</button></a><?php } ?></td>
