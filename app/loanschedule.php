												...
												<tbody>
													...
													<tr>
														...
														if($paid=="Y"){
															...
															if($minid==$repid){
																if($lapproved=="Y"){
																$retst="<span style='color:red;font-weight:bold;'>UnPaid</span>&nbsp;<a href='javascript:payLoan(\"$repid\")' class='btn btn-sm btn-primary' target='_blank'>Pay <i class='fa fa-credit-card'></i> </a>";
																}else{
