...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Blueroll Installation</title>
					...
					<div class="col-sm-10 col-sm-offset-1">
						<div class="login-container">
							<div class="center">
								...
								<h4 id="id-company-text" style="color:white;font-size:26px">Install</h4>
...
<span style="color:red;font-size:16px;font-weight:bold;" id="sperror2"></span>
							...
							<font style="color:white;"><center>&copy; Chromenet<br>nairatag@gmail.com</center></font>
						</div>
