			...
			$.post("controller/utility.php", {schedid:schedid,act: 'markloanpayment'},
						   function (data) {
							   ...
							   if (data.length > 0) {
								   ...
								   if(data=="1"){
									Tvar("divpayment").innerHTML="<div style='font-size:30px;'>Payment Successful<br><span style='font-size:20px;'></span><br><a href='loanscheduleadmin.php?id="+loanid+"'>Click here to Continue</a></div><br>"
