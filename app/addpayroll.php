							...
							<div class="col-md-8">
								<div class="card">
									<div class="card-header">
										<div class="card-title">New Payroll</div>
									</div>
									<div class="card-body">
									<span id="diva"></span>
										<div class="form-group ">
											...
											<input type="text" class="form-control w-100" id="txtpayroll"  placeholder="Enter Payroll Description here">
										</div>
									...
									<div class="card-footer">
										<button type="button" class="btn btn-primary waves-effect waves-light" onclick="saveGrade();">Create Payroll</button>&nbsp;&nbsp;<a href='payrollproject.php'><button type="button" class="btn btn-red waves-effect waves-light">Cancel</button></a>
									</div>
								</div>
							</div>
			...
			function saveGrade(){
				...
				if(txtwef==""){
					return
						...
						$.post("controller/utility.php", {txtwef:txtwef,txtpayroll:txtpayroll,act: 'addpayroll',cbofrequency:cbofrequency},
						   function (data) {
