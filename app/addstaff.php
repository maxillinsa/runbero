							...
							<div class="col-md-8">
								<div class="card">
									...
									<div class="card-footer">
										<button type="button" class="btn btn-primary waves-effect waves-light" onclick="saveGrade();">Save Employee Record</button>&nbsp;&nbsp;<a href='employees.php'><button type="button" class="btn btn-red waves-effect waves-light">Cancel</button></a>
									</div>
								</div>
							</div>
