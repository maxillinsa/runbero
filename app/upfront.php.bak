							...
							<div class="col-md-12 col-lg-12">
								<div class="card">
									<div class="card-header">
										<div class="card-title">Existing Upfront Projects</div>

									</div>
									
									<div class="card-body">
									<a href="addupfront.php" class="btn btn-primary"> <i class="fa fa-plus"></i> Create New Upfront</a><br><br>
									<?php 
											...
											<table id="example2" class="hover table-bordered border-top-0 border-bottom-0" >
												...
												<tbody>
													...
													<tr>
														...
														<td>
													<a href="upfrontitems.php?id=<?php echo $ido; ?>">	<button type="button" class="btn btn-sm btn-primary waves-effect waves-light" onclick="saveGrade();"><i class="fa fa-edit"></i> Add Item</button>
