								...
								<div class="card">
									...
									<span id="diva"></span>
										...
										<div class="form-group ">
											...
											<input type="number" class="form-control w-100" value="<?php echo $rdx['intrate']; ?>" id="txtinterest"  placeholder="Enter interest rate e.g. 5 or 10">
										</div>
									...
									<div class="form-group ">
											...
											<input type="number" class="form-control w-100" value="<?php echo (int)$rdx['principal']; ?>" id="txtprincipal"  placeholder="Enter Loan Application Amount">
										</div>
									...
									<button id="btnprocess" type="button" class="btn btn-secondary waves-effect waves-light" onclick="processLoan();">Process</button>&nbsp;&nbsp;<button type="button" class="btn btn-warning waves-effect waves-light" onclick="reloadpage();">Reload</button>&nbsp;&nbsp;<button type="button" class="btn btn-primary waves-effect waves-light" onclick="saveGrade();">Save Loan</button>&nbsp;&nbsp;<a href='loanrequests.php'><button type="button" class="btn btn-red waves-effect waves-light">Cancel</button></a>
									</div>
								</div>
							</div>
		...
		var empid="<?php echo $empid; ?>";
			function saveGrade(){
				...
				if(cboloantype==""){
					...
					$.post("controller/utility.php", {lid:lid,cboloantype:cboloantype,cboemployee:cboemployee,tenor:tenor,intrate:intrate,principal:principal,act: 'editsaveloan',insttype:insttype,txtstartdate:txtstartdate },
						   function (data) {
