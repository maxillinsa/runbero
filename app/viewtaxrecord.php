					...
					<div class="side-app">
						<div class="page-header">
							...
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page">Tax Record</li>
							</ol>
						</div>
							...
							<div class="col-md-12 col-lg-10">
								<div class="card">
									...
									<i class='fa fa-certificate'></i>Tax Record</div>
...
select tblrunlogitemsup.empid,tblrunlogitemsup.amount,payitemname from tblrunlogitemsup,tblpayelement,tblrunlogup where tblpayelement.id=pelementid and tblpayelement.crita in ('TAXG','TAXA') and tblrunlogup.id=tblrunlogitemsup.logid and tblrunlogup.approved='Y' 
