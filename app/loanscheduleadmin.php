...
<html lang="en" dir="ltr">
	<head>
												...
												<tbody>
													...
													<tr>
														...
														if($paid=="Y"){
															...
															if($minid==$repid){
																if($lapproved=="Y"){
																$retst="<span style='color:red;font-weight:bold;'>UnPaid</span>&nbsp;<a href='javascript:payLoan(\"$repid\");' class='btn btn-sm btn-primary'>Pay <i class='fa fa-credit-card'></i> </a>";
																}
															}else{
		...
		<script>
			...
			function payLoan(id){
				//alert(id);
				window.location="payloan.php?schedid="+id;
			}
