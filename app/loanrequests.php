	...
	<head>
						...
						<div class="page-header">
							...
							<div class="col-md-12 col-lg-12">
								<div class="card">
									...
									<div class="card-body">
									<?php 
										$qry="select * from  tblloans where compid=$compid and approved not in ('Y')";
									//	echo $qry;
										$res=mysql_query($qry);
		...
		$instmt=returnQueryValue("select instamount from tblloanshedule where id=$minid","instamount");
														...
														echo "<span style='font-size:10px;'>".$status."</span>"; ?></td>
															...
															<td>
															<a href='discussloan.php?id=<?php echo $lid; ?>' target='_blank'><button class='btn btn-sm btn-info'> Chat <i class='fa fa-commenting-o'></i></button> </a>
														</td>
														<td><?php 
														$cby=$rd['createdby'];
														...
														<td><?php echo $rd['ddate']; ?></td>
															...
															if($signagreed=="R"){
																echo "<center style='font-size:10px;'>Agreement Sent. Waiting Applicant Approval</center>";
															...
															if($signagreed=="J"){
																echo "<center STYLE='color:red;font-weight:bold;'>Agreement Rejected <a href='requestagreement.php?id=$lid' class='btn btn-sm btn-warning' >Resend Loan Agreement <i class='fa fa-paper-plane'></i> </a></center>";
															...
															<td><?php 
															echo "<a href='loanschedule.php?id=$lid' class='btn btn-sm btn-primary' target='_blank'>View Scedule <i class='fa fa-search'></i> </a>&nbsp;&nbsp;";
															if($approved=="N"){
																if($signagreed=="Y"){
																echo " <a href='approveloan.php?id=$lid' class='btn btn-sm btn-info' target='_blank'>Approve <i class='fa fa-check'></i> </a>";
																}
																}
															if($signagreed=="N"){
																echo " <a href='requestagreement.php?id=$lid' class='btn btn-sm btn-warning' target='_blank'>Send Loan Agreement <i class='fa fa-paper-plane'></i> </a>&nbsp;&nbsp;";
															}
															if($approved=="N"){
																echo "<a href='editloan.php?id=$lid' class='btn btn-sm btn-warning' target='_blank'>Edit Loan <i class='fa fa-pencil'></i> </a>&nbsp;&nbsp;";
															}
															...
															if($approved=="J"){
																echo "<span style='color:Red'><b>Declined</span>";
															}else{
																echo "<a href='rejectloan.php?id=$lid' class='btn btn-sm btn-red'>Decline <i class='fa fa-ban'></i> </a>&nbsp;&nbsp;";
															}
