					...
					<div class="side-app">
						...
						<?php 
						 ...
						 header('Content-Type: application/vnd.ms-excel');
							header("Content-Disposition: attachment; filename=\"ALL_PAYROLL_".date("Y-m-d H:i:s").".xls\"");
						 ...
						 $printa="";
							...
							$printa.="<b><font size='5'>Payroll Data</font></b><br>";
							$expqr="select distinct grade from tblrunlogitems,tblemployee where logid=$logid and  tblemployee.id=empid";
							...
							do{
								...
								$qr1="select distinct pelementid from tblrunlogitems where logid=$logid";
								//echo $qr1."<br>";
								$rs1=mysql_query($qr1);
								...
								do{
									...
									if($pelementname=="" && $peleid<>'BASIC'){
										$peleid=str_replace("CUSTOM","",$peleid);
										
										$pelementname=returnQueryValue("select payelement from tblemployeepayelement where id=$peleid","payelement");
								...
								$qr2="select distinct empid from tblrunlogitems,tblemployee where logid=$logid and grade=$gradeid and tblemployee.id=empid and tblrunlogitems.empid=tblemployee.id";
								$rs2=mysql_query($qr2);
								...
								do{
									...
									$qr3="select empid,pelementid,amount,creditdebit from tblrunlogitems,tblemployee where logid=$logid and grade=$gradeid and 
									tblemployee.id=$empid and tblrunlogitems.empid=$empid";
