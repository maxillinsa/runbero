	...
	<head>
							...
							<div class="col-md-8">
								<div class="card">
									...
									<div class="card-footer">
										<button type="button" class="btn btn-primary waves-effect waves-light" onclick="saveGrade();"><i class="fa fa-paper-plane"></i> Send Invite</button>&nbsp;&nbsp;<a href='invites.php'><button type="button" class="btn btn-red waves-effect waves-light">Cancel</button></a>
									</div>
		...
		<script>
			...
			function saveGrade(){
				...
				$.post("controller/utility.php", {txtfname:txtfname,txtemail:txtemail,act: 'addinvite',txttel: txttel,cborole:cborole},
						   function (data) {

							   if (data.length > 0) {
								   //Tvar("registerpanel").innerHTML=data;
								  //alert(data);
								
								if(data=="exists"){
									//tError("ERROR: You have already invited contact<br>");
									apprise("<font color='red'>ERROR: Invite sent already</font>");
									return;
								}
