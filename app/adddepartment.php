	...
	<head>
								...
								<div class="card">
									...
									<span id="diva"></span>
										<div class="form-group ">
											...
											<input type="text" class="form-control w-100" id="txtdepartment"  placeholder="Enter Department here">
										</div>
								
									
									</div>
									<div class="card-footer">
										<button type="button" class="btn btn-primary waves-effect waves-light" onclick="saveGrade();">Save Department</button>
									</div>
								</div>
							</div>
		...
		<script>
			...
			function saveGrade(){
				...
				var txtdepartment=Tvar("txtdepartment").value;
				...
				if(txtdepartment==""){
					return
						...
						$.post("controller/utility.php", {txtdepartment:txtdepartment,act: 'adddepartment'},
						   function (data) {
							   ...
							   if (data.length > 0) {
								...
								if(data=="exists"){
									...
									Terror("Department already exists","diva");
									return;
								}
