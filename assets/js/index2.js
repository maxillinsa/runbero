...
/* Chart-js (#lineChart1) */
	...
	gradientStroke1.addColorStop(0, 'rgb(0, 123, 255 ,0.3)');

	var gradientStroke2 = myCanvasContext.createLinearGradient(0, 0, 0, 190);
	gradientStroke2.addColorStop(0, 'rgb(22, 189, 60,0.3)');
	...
	gradientStroke1.addColorStop(0, 'rgb(0, 123, 255 ,0.8)');

	var gradientStroke2 = myCanvasContext.createLinearGradient(0, 0, 0, 300);
	gradientStroke2.addColorStop(0, 'rgb(22, 189, 60,0.8)');
	var myChart = new Chart(myCanvas, {
		type: 'bar',
		data: {
...
$(function(e){
  'use strict'
	...
	new Morris.Donut({
		  element: 'morrisBar8',
		  data: [
			{value: 95, label: 'Android'},
			{value: 30, label: 'Windows'},
			{value: 45, label: 'Mac'},
			{value: 20, label: 'Business Apps'},
		  ],
		  colors: [
		'#007bff', '#16bd3c ', '#00e682', '#ff382b'
